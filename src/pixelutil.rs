...
fn test_add_pixel() {
    assert_eq!(
        add_pixel(
            image::Rgb::<f32>([1., 2., 3.]),
            &image::Rgb::<f32>([10., 20., 30.])
        ),
        image::Rgb::<f32>([11., 22., 33.])
    );
    assert_eq!(
        add_pixel(
            image::Rgb::<f32>([10., 20., 30.]),
...
fn test_scale_pixel() {
    assert_eq!(
        scale_pixel(3.5, image::Rgb::<u8>([1, 2, 3])),
        image::Rgb::<f32>([3.5, 7.0, 10.5])
    );
    assert_eq!(
        add_pixel(
            image::Rgb::<f32>([10., 20., 30.]),
            &scale_pixel(2., image::Rgb::<u8>([1, 2, 3]))
        ),
        image::Rgb::<f32>([12., 24., 36.])
    );
}
